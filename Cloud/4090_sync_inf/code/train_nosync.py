...
'''
def train_func_nosync(net, train_iter, test_iter, num_epochs, lr, device):
    ...
    for epoch in range(num_epochs):
        ...
        # 其中包括：time to device, forward time, loss cal time, backward time, optimizer time, and in each epoch the cal test acc time
