...
def solve_gurobi(start_hour, end_hour, instance,contributions,E_max, alpha, beta, theta, G_max_solar, G_max_grid, GPU_power_options, electricity_price, sell_back_price):
    ...
    energy_dispatch_df.to_csv('/Users/jingsichen/Politecnico Di Torino Studenti Dropbox/Jingsi Chen/Mac/Desktop/AI/results/Duration{}_start{}.csv'.format(end_hour-start_hour, start_hour), index=False)
