# Historical GreenAI navigation context

Moved from CLAUDE.md during the shared-instruction maintenance on 2026-09-12.
This is dated background, not current measurements, defaults, or acceptance
evidence. Paths below are relative to the GreenAI repository root.
